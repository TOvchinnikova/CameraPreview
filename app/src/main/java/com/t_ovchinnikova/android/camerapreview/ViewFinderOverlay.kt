...
class ViewFinderOverlay(
    ...
    private fun initDefaultAttrsValues() {
        ...
        backgroundRecticle = ContextCompat.getColor(context, BACKGROUND_RECTICLE_DEFAULT_COLOR)
        strokeBoxWidth = STROKE_BOX_WIDTH_DEFAULT
        boxCornerRadius = BOX_CORNER_RADIUS_DEFAULT
    ...
    companion object {
        ...
        const val BACKGROUND_RECTICLE_DEFAULT_COLOR = R.color.recticle_background
        const val STROKE_DEFAULT_COLOR = Color.WHITE

        const val STROKE_BOX_WIDTH_DEFAULT = 1f
        const val BOX_CORNER_RADIUS_DEFAULT = 10f
    }
}